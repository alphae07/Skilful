...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Skilful|Forgot Password</title>
...
<h2>Forgot Password!/Change Password</h2>
                    <form method="post" action="forgot_process.php">
                        <?php if(isset($_GET['err'])){
                            $err=$_GET['err'];
                            echo "<p class='errmsg'>User not found.</p>";
                        }
                        ...
                        if(isset($_GET['somethingwrong'])){
                            ...
                            echo "<p class='errmsg'>Something went wrong. Please try again later.</p>";
                        }
                        if(isset($_GET['sent'])){
                            
                            echo "<p class='successmsg'>Reset link has been sent to you registered email id. Kindly check your email. It can take 2=3 minutes to deliver on your email id.</p>";
                        }
                        ?>

                        <?php
                            if(!isset($_GET['sent'])){?>
                                <label for='email'><p>Your Email</p>
                                    <input type='email' name='email' required>
                                </label>
                                <button type="submit" class="enter">Send Link</button>
                              <?php  }?>
                            </form>
                            <br>
                            <p>Have an account? <a href="log-in.php">Login</a> </p>
