    ...
    <title>Skilful|Inbox</title>
     ...
     <style>
            * {
            ...
            .alpha-1 form .button:hover, .alpha-1 form .button:active {
...
<path d="M17 9L13.87 11.5C12.84 12.32 11.15 12.32 10.12 11.5L7 9" stroke="#353535" stroke-opacity="0.2" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
          ...
          <!--   Main Page    -->
            ...
            <div class="main">
                <div class="container">
                <!--form class="user">
                    <input type="text" name="user" placeholder="Search Chat...">
                    <button><i class="fa fa-magnifying-glass"></i></button>
                </form-->
                <div class="bar">
                    <div class="bar-text">&nbsp; Recent Conversations &nbsp;</div>
                </div>
                ...
                ?>
                    ...
                    <!--a href="new-msg.php" class="msg">
                        <img src="#">
                        <div class="sender">
                            <div class="some">
                                <p>Freddie White</p>
                                <i class="fa-solid fa-circle status active"></i>
                                
                            </div>
                            <div>
                                <span>Can you deliver before Next week?</span><span>3:27pm</span>
                            </div>
                        </div>
                    </a>
