...
<path d="M17 9L13.87 11.5C12.84 12.32 11.15 12.32 10.12 11.5L7 9" stroke="#353535" stroke-opacity="0.2" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
          ...
          <!--   Main Page    -->
            ...
            <div class="main">
                <div class="container">
                     <h3>Update Your Buyer Account</h3>                 
                     <form method="post" enctype="multipart/form-data" class="account" action="prochange.php">
...
?>
                     <label for='fname'><p>First Name</p>
                     ...
                     <!--label for="gender"><p>Gender</p>
                        ...
                        <select name="gender" id="gender">
                            ...
                            <option class="hide" value="<?php echo $row['gender']; ?>" selected="selected"><?php echo $row['gender']; ?></option>

                        </select>
                        </label-->
                     
                      <label for='phone'><p>Phone Number</p>
                         <input type='text' id="phone" name="tel" disabled value="<?php echo $row['phone']; ?>">
                     </label>
                     ...
                     <div style="width:80%;"><hr style="margin:4vh 0;"></div>
                    ...
                    <label for="country"><p>Location State</p>
                      ...
                      <label for="pic"><p>Your Picture</p>
                         <input type='file' id="pic" name="pic" accept="image/png, image/jpg, image/jpeg">
                     </label>
