...
<head>
    ...
    <title>Skilful|Product View</title>
  ...
  -ms-filter: blur(1px);
    ...
    -webkit-filter: blur(0)!important; 
           ...
           .product .delete {
            ...
            .pur button:hover, .pur button:active {
                background-color:#353535;
            }
            .other {
                width:100%;
...
<path d="M17 9L13.87 11.5C12.84 12.32 11.15 12.32 10.12 11.5L7 9" stroke="#353535" stroke-opacity="0.2" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            <?php
                ...
                $sql1 = mysqli_query($con, "SELECT * FROM products WHERE product_id = {$product_id}");
                if(mysqli_num_rows($sql1) > 0){
                $row1 = mysqli_fetch_assoc($sql1);
                }


                $sql2 = mysqli_query($con, "SELECT * FROM user WHERE unique_id = {$row1['user_id']}");
          ...
          <!--   Main Page    -->
            ...
            <div class="container">
                ...
                <div class="sellr">
                    <img src="seller/image/<?php echo $row2['img_id'] ?>">
                    <a href="seller_view.php?seller_id=<?php echo $row2['unique_id'] ?>" class="nfo">
                        <p><?php echo $row2['shop_name'] ?></p>
                        <span><?php echo $row2['services'] ?></span>
                        <span><?php echo $row2['mylocation'] ?></span>
                    </a>
                    <div class="cont">
                        <a href="#"><i class="fa fa-plus"></i></a>
                        <a href="new-msg.php?user_id=<?php echo $row2['unique_id'] ?>"><i class="fa-solid fa-message"></i></a>
                    </div>
                </div> 
                
                <div class="pimg"><img src="seller/products/<?php echo $row1['product_img'] ?>"></div>
                <div class="pric"><h2><?php echo $row1['product_name'] ?></h2><p>NGN<?php echo $row1['product_price'] ?></p></div>
                <div class="desc" style="white-space: pre-line;"><?php echo $row1['product_desc'] ?></div>

                <a href="new-msg.php?user_id=<?php echo $row2['unique_id'] ?>&purchase=Hi, I want to buy [Amount] <?php echo $row1['product_name'] ?>. Will you deliver it or I should come pick it up?" class="pur"><button>Purchase</button></a>

                <div class="other">
                    <div class="hr"><hr></div>
                    <h3>Seller's Other Products</h3>
                    <div class="hr"><hr></div>
                    <div class="wrapper">
                        <?php 
                            include_once 'other_product.php';
                        ?>
                    </div> 
                </div> 
