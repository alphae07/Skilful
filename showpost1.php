...

{
    ...
    $user_id =  mysqli_real_escape_string($con, $_GET['seller_id']);
    ...
    $sql = "SELECT * FROM posts WHERE (user_id = {$user_id}) ORDER BY rand() DESC LIMIT 10";
...

    {
        ...
        while($row = mysqli_fetch_assoc($query)){
            ...
            $sql1 = "SELECT * FROM user WHERE (unique_id = {$user_id}) ORDER BY id DESC LIMIT 10";
            ...
            if($row['user_id'] === $user_id){
                ...
                <p 'width:100%;text-align:center;font-size:small; margin:1vh 0;'>No Available Post</p>
