...

{
    ...
    $output = "";
            ...
            $sql1 = "SELECT * FROM user WHERE unique_id != '$user_id' order by rand() LIMIT 8";
            ...
            if($row['user_id'] !== $user_id){
                ...
                <div class="product">
                <span class="delete"><a href="get_app.php"><i class="fa fa-heart"></i></a><a href="product_view.php?id='. $row['product_id'] .'"><i class="fa fa-cart-shopping"></i></a></span>
                
                <div class="product-body">
                    <img src="seller/products/'. $row['product_img'] .'">
                </div>
                <a href="product_view.php?id='. $row['product_id'] .'" class="product-footer">
